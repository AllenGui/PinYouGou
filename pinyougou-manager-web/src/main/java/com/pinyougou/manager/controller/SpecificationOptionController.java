...
public class SpecificationOptionController {
	 ...
	 */
	@RequestMapping("/add")
	public CurrentResult add(@RequestBody TbSpecificationOption specificationOption){
		try {
	...
	public CurrentResult update(@RequestBody TbSpecificationOption specificationOption){
		try {
	...
	public TbSpecificationOption findSingle(Long id){
		return specificationOptionService.findSingle(id);		
	}
